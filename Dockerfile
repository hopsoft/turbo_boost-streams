...
RUN ln -s /opt/node_modules /opt/turbo_boost-streams/node_modules
...
CMD rm -rf /opt/turbo_boost-streams && \
...
ln -s /opt/node_modules /opt/turbo_boost-streams/node_modules && \
